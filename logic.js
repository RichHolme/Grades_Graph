$( document ).ready(function() {
	...
	var chart = new Chart(ctx, {
	    ...
	    data: {
	        labels: ['Aug 15 2019', 'Sept 18 2019', 'Sept 30 2019', 'Oct 10 2019', 'Oct 11 2019', 'Oct 22 2019'],
	        datasets: [{
	            label: 'Mat 172',
	            borderColor: "#dd2c00",
	            pointBackgroundColor: "#dd2c00",
	            pointBorderColor: "#dd2c00",
	            data: [100, 83.79, 83.89, 83.80, 89.00, 89.42]
	        }]
	    },
	...
	var chart2 = new Chart(ctx2, {
	    ...
	    // The data for our dataset
	    data: {
	        labels: ['Aug 15 2019', 'Aug 25 2019', 'Sept 22 2019', 'Oct 21 2019'],
	        datasets: [{
	            label: 'Eng 231',
	            borderColor: "#dd2c00",
	            pointBackgroundColor: "#dd2c00",
	            pointBorderColor: "#dd2c00",
	            data: [100, 96.6, 89.73, 91.19]
	        }]
	    },
